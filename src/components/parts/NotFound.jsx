    ...
    <div className='relative z-20'>
      <div className='flex flex-col items-center'>
        ...
        <div className='w-full bg-orange-100/20 h-[50px] h-xsm:h-[150px] h-sm:h-[300px] h-md:h-[550px] h-lg:h-[800px]'>
          <div className='mx-2 xsm:mx-auto p-2 xsm:p-4 text-purple-900 w-fit xsm:w-11/12 lg:w-3/4 xl:w-3/5 2xl:w-1/2 text-center bg-orange-500/50 hover:bg-orange-500 rounded-lg group/about shadow-[0_0_5px_black] hover:shadow-[0_0_15px_black] transition duration-500'>
