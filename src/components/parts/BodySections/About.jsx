...
const About = () => {
  ...
  return (
    <div className='bg-orange-500/20 '>
      ...
      >
        {/* Heading */}
        <div className='text-pink-200 group-hover/about:text-orange-900 font-bold text-2xl sm:text-4xl text-center'>About Me</div>

        {/* Content of About Section */}
        <Fade duration={revealDuration} delay={revealDelay}>
          <div className='text-pink-200 group-hover/about:text-pink-950'>
